...
const history = [
  {
    year: '2022',
    text: 'VAN 첫 모임',
    detail: '서로 다른 학교와 전공의 멤버들이 함께 배우기 위해 모였습니다.',
  },
  {
    year: '2023',
    text: '첫 팀 프로젝트',
    detail: '관심사를 아이디어에 그치지 않고 팀의 결과물로 완성했습니다.',
  },
  {
    year: '2024',
    text: '활동 분야 확대',
    detail: '스터디와 프로젝트, 교류 프로그램으로 활동의 폭을 넓혔습니다.',
  },
  {
    year: '2025',
    text: '연합 커뮤니티 성장',
  ...
  return (
    <main>
      <section className="company-hero page-section">
        ...
        <p>
          VAN은 다양한 대학과 전공의 구성원이 관심사를 나누고 서로의 경험을 배우며,
