export const conferenceEditions = [
  {
    id: 'van-conference-2026',
    year: '2026',
    slug: '2026',
    ...
    localized: {
      ko: {
        meta: {
          title: 'VAN Conference 2026 | 공식 행사 안내',
          description: '대격변의 시대, 혁신을 묻다. VAN Conference 2026의 연사, 프로그램과 참가 준비 현황을 확인합니다.',
        },
        hero: {
          ...
          items: [
            {
              ...
              status: 'development',
              category: '기술·산업 분야',
              developmentMessage: '공식 공개 전인 연사 정보입니다.',
            },
            {
          ...
          items: [
            {
              ...
              endAt: null,
              title: '기술혁신',
              description: '기술 변화와 산업·사회 전환을 함께 살펴보는 프로그램 방향입니다.',
              speakers: [],
            },
            {
              id: 'social-political-innovation',
              status: 'development',
              time: null,
              startAt: null,
              endAt: null,
              title: '사회·정치혁신',
              description: '사회 구조와 정치 환경의 전환을 함께 살펴보는 프로그램 방향입니다.',
              speakers: [],
            },
            {
              id: 'plenary-discussion',
              status: 'development',
              time: null,
              startAt: null,
              endAt: null,
              title: '종합 디스커션',
              description: '각 세션에서 제안된 관점을 하나의 대화로 연결하는 종합 토론 방향입니다.',
              speakers: [],
            },
            {
              ...
              endAt: null,
              title: '알럼나이 네트워킹 나잇',
              description: '서로 다른 분야와 세대의 참가자가 후속 대화를 이어가는 네트워킹 방향입니다.',
              speakers: [],
            },
          ],
        },
        ...
        faq: {
          ...
          items: [
            {
              id: 'schedule',
              question: '행사 일정과 장소는 언제 공개되나요?',
              answer: '기획팀 확인이 끝난 뒤 이 페이지의 행사 정보 영역에 업데이트합니다.',
            },
            {
              id: 'speakers',
              question: '연사와 세부 프로그램은 어디에서 확인하나요?',
              answer: '연사와 세션이 확정되면 연사와 프로그램 영역에 순서대로 공개합니다.',
            },
            {
              id: 'application',
              question: '참가 신청은 어떻게 하나요?',
              answer: '신청 일정과 링크가 확정되면 참가 안내 페이지와 이 행사 페이지에 함께 안내합니다.',
            },
            {
              id: 'partners',
              question: '협력 기관과 후원사는 언제 공개되나요?',
              answer: '공식 협의와 로고 사용 확인을 마친 기관부터 파트너 영역에 공개합니다.',
            },
          ],
        },
        application: {
          eyebrow: '컨퍼런스 참여',
          title: '참가 안내',
          body: '참가 대상, 모집 일정과 신청 링크는 공식 내용이 확정되는 순서대로 참가 안내 페이지와 이곳에 함께 안내합니다.',
          linkLabel: '참가 안내 보기',
        },
        highlights: {
          eyebrow: '07 / 행사 기록',
        ...
        archive: {
          title: 'VAN Conference 2026',
          summary: '2026 행사 안내와 행사 종료 후 사진·영상·주요 기록을 같은 연도 페이지에 축적합니다.',
      ...
      en: {
          ...
          items: [
            {
              ...
              developmentMessage: 'This speaker profile has not been published.',
            },
            {
              id: 'society-politics-speaker',
              status: 'development',
          ...
          items: [
            {
              ...
              description: 'A programme direction examining technological change and industrial and social transition.',
              speakers: [],
            },
            {
              id: 'social-political-innovation',
              ...
              description: 'A programme direction examining changes in social structures and political environments.',
              speakers: [],
            },
            {
              id: 'plenary-discussion',
              ...
              description: 'A plenary direction connecting perspectives from across the programme.',
              speakers: [],
            },
            {
              id: 'alumni-networking',
              ...
              description: 'A networking direction connecting participants across fields and generations.',
              speakers: [],
            },
          ],
        },
        ...
        faq: {
          ...
          items: [
            {
              id: 'schedule',
              question: 'When will the date and venue be announced?',
              answer: 'They will be added to the event facts on this page after the planning team completes its review.',
            },
            {
              id: 'speakers',
              question: 'Where can I find speakers and the full programme?',
              answer: 'Confirmed speakers and sessions will be published in the SPEAKERS and PROGRAMME sections.',
            },
            {
              id: 'application',
              question: 'How can I apply to attend?',
              answer: 'Once confirmed, the application period and link will appear on both the APPLICATION page and this event page.',
            },
            {
              id: 'partners',
              question: 'When will partners and sponsors be announced?',
              answer: 'Organizations will appear in the PARTNERS section after formal coordination and logo-use approval are complete.',
            },
          ],
        },
        application: {
          ...
          body: 'Eligibility, application dates and links will be published here and on the APPLICATION page as official details are confirmed.',
        ...
        archive: {
          title: 'VAN Conference 2026',
          summary: 'Event information, photography, video and highlights will remain on this permanent edition page.',
...
export const conferenceEditionRoutes = conferenceEditions.map(({ year, slug }) => ({
  key: 'conferenceEdition',
  navKey: 'conference',
  kind: 'edition',
...
export function getConferenceEdition(year, lang = 'ko') {
  const source = conferenceEditions.find((edition) => edition.year === String(year))
  ...
  return {
    ...
    structuredEvent: source.structuredEvent,
    statusLabel: getConferenceStatusLabel(lang, source.publicationStatus),
    ...source.localized[lang],
  }
}

export function getConferenceEditionSummaries(lang = 'ko') {
  return conferenceEditions
    .map(({ year }) => getConferenceEdition(year, lang))
    .filter(Boolean)
    .sort((left, right) => Number(right.year) - Number(left.year))
}

export function getConferenceStatusLabel(lang, status) {
  const labels = {
    ko: {
      confirmed: '확정',
      published: '공개',
    ...
    en: {
      confirmed: 'Confirmed',
      published: 'Published',
      archived: 'Past conference',
      development: 'Details to follow',
    },
  }

  return labels[lang]?.[status] || labels[lang]?.development || labels.en.development
}
