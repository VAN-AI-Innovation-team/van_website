...
export const supportPage = {
  ko: {
    ...
    formNumber: '03',
    formSubtitle: '정기 후원 신청',
    formTitle: '정기 후원 신청하기',
    formLead: '아래 내용을 남겨주시면 담당자가 확인한 뒤 후원 절차와 월간 활동 리포트 발송을 안내드립니다. 북 펀딩은 텀블벅에서 바로 참여하실 수 있습니다.',
    formLabels: {
      name: '성함',
      phone: '연락처',
      email: '이메일',
    ...
    formAmounts: ['월 1만원', '월 3만원', '월 5만원', '월 10만원', '직접 입력'],
    formSubmit: '메일로 신청 보내기',
    formCopy: '신청 내용 복사',
    formCopied: '복사했습니다',
    formHint: '버튼을 누르면 메일 앱이 열리고 신청 내용이 자동으로 채워집니다. 메일 앱을 쓰지 않으시면 신청 내용을 복사해 문자로 보내주셔도 됩니다.',
    formSubject: '정기 후원 신청',
  ...
  en: {
    ...
    formNumber: '03',
    formSubtitle: 'Sign Up',
    formTitle: 'Sign up for monthly giving',
    formLead: 'Leave your details and we will confirm the process and set up your monthly activity report. Book funding runs directly on Tumblbug.',
    formLabels: {
      name: 'Name',
      phone: 'Phone',
      email: 'Email',
    ...
    formAmounts: ['KRW 10,000 / month', 'KRW 30,000 / month', 'KRW 50,000 / month', 'KRW 100,000 / month', 'Other'],
    ...
    formSubject: 'Monthly giving sign-up',
