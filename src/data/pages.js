...
export const supportPage = {
  ko: {
    ...
    waysContactLead: '후원 담당자와 연락처를 먼저 확인한 뒤 전화나 이메일로 문의하실 수 있습니다.',
    ways: [
      {
        tag: 'BOOK FUNDING',
        title: '북 펀딩',
        body: 'VAN 상설연구조직이 기획하고 청년 필진이 직접 집필한 사회비평 에세이집 『선 위에 선 우리들』의 인쇄와 배포, 후속 발간 작업을 후원하는 방식입니다.',
        points: ['도서 발간 및 배포 비용', '후속 연구·발간 작업'],
        note: '텀블벅 펀딩 페이지에서 후원 구성과 선물을 확인하고 바로 참여하실 수 있습니다.',
        fundingUrl: 'https://tumblbug.com/veritasvan',
        fundingLabel: '텀블벅에서 펀딩 참여하기',
      ...
      },
      {
        tag: 'MONTHLY GIVING',
        title: '개인 후원',
        body: '아래 신청서에 기본 정보와 희망 후원 방식을 남긴 뒤 매월 일정 금액을 후원할 수 있습니다. 부담 없는 수준에서 시작해 언제든 조정하실 수 있습니다.',
        tiers: ['월 1만원', '월 3만원', '월 5만원', '월 10만원'],
        points: ['신청서에 성함·전화번호·이메일을 남겨주세요', '은행 앱에서 아래 계좌로 매월 자동이체를 설정할 수 있습니다'],
        note: '카드 정기결제는 PG 계약과 정기결제 시스템이 준비된 뒤 제공할 수 있습니다.',
        linkLabel: '개인 후원 신청서 작성',
        linkAnchor: 'support-application',
      },
      {
        tag: 'PARTNERSHIP',
        title: '기업·단체 후원',
        ...
        note: '제안이나 문의는 아래 신청서 또는 후원 담당자 연락처로 보내주세요.',
        linkLabel: '후원·협력 문의 남기기',
        linkAnchor: 'support-application',
      },
    ],
    formNumber: '03',
    formSubtitle: '후원 신청',
    formTitle: '후원 정보를 남겨주세요',
    formLead: '사이트에서 성함과 연락처, 희망 후원 방식을 작성할 수 있습니다. 제출하면 입력한 내용이 담긴 이메일 작성 화면이 열립니다.',
    formLabels: {
      type: '후원 방식',
      name: '성함',
      phone: '연락처',
      email: '이메일',
      amount: '후원 금액',
      amountCustom: '금액을 직접 입력해주세요',
      message: '남기실 말 (선택)',
      consent: '후원 안내를 위해 성함·연락처·이메일 수집에 동의합니다. 안내 목적 외에는 사용하지 않습니다.',
      required: '필수',
    },
    formAmounts: ['미정 / 상담 후 결정', '월 1만원', '월 3만원', '월 5만원', '월 10만원', '직접 입력'],
    formSubmit: '이메일로 신청 내용 보내기',
    formCopy: '신청 내용 복사',
    formCopied: '복사했습니다',
    formHint: '버튼을 누르면 메일 앱이 열리고 신청 내용이 자동으로 채워집니다. 메일 앱을 쓰지 않으시면 신청 내용을 복사해 문자로 보내주셔도 됩니다.',
    formSubject: '[VAN 후원 신청]',
    formIncomplete: '필수 항목과 동의 여부를 확인해주세요.',
    formPlaceholders: {
      name: '홍길동',
      phone: '010-0000-0000',
      email: 'name@example.com',
      message: '후원 주기나 문의 사항을 자유롭게 적어주세요.',
    },
    formTypes: ['개인 정기 후원', '북 펀딩', '기업·단체 후원', '기타 문의'],
    formStatus: '입력 내용이 담긴 이메일 작성 화면을 열었습니다. 전송 버튼까지 눌러야 접수가 완료됩니다.',
    formPrivacy: '이 페이지는 입력 내용을 별도 서버나 데이터베이스에 저장하지 않습니다. 메일 앱이 열리지 않으면 아래 공식 이메일로 직접 보내주세요.',
    paymentTitle: '정기 후원은 이렇게 진행됩니다',
    paymentLead: '현재 카드 자동결제는 제공하지 않습니다. 신청서를 보낸 뒤 은행 앱에서 VAN 후원 계좌를 받는 계좌로 지정하고 매월 자동이체를 설정해주세요.',
    paymentSteps: ['후원 신청서 작성', '공식 이메일로 신청 내용 전송', '은행 앱에서 매월 자동이체 설정'],
    paymentAccountLink: '후원 계좌 확인하기',
    contactPersonLabel: '후원 담당',
    phoneLabel: '전화',
    emailLabel: '이메일',
    accountNumber: '04',
  ...
  en: {
    ...
    waysContactLead: 'See the donation contact first, then reach us directly by phone or email.',
    ways: [
      {
        tag: 'BOOK FUNDING',
        title: 'Book funding',
        ...
        note: 'The Tumblbug page lists every tier and reward, and you can back the project there directly.',
        fundingUrl: 'https://tumblbug.com/veritasvan',
        fundingLabel: 'Back the project on Tumblbug',
      ...
      },
      {
        ...
        body: 'Leave your contact details and preferred giving route in the form below, then give a set amount each month. You can adjust it at any time.',
        tiers: ['KRW 10,000 / month', 'KRW 30,000 / month', 'KRW 50,000 / month', 'KRW 100,000 / month'],
        points: ['Leave your name, phone number and email in the form', 'Set up a monthly standing order to the account below in your banking app'],
        note: 'Recurring card payments require a payment-provider agreement and billing system and are not available yet.',
        linkLabel: 'Complete the giving form',
        linkAnchor: 'support-application',
      },
      {
        tag: 'PARTNERSHIP',
        ...
        note: 'Please use the form below or contact the donation manager with proposals or questions.',
        linkLabel: 'Leave a partnership enquiry',
        linkAnchor: 'support-application',
      },
    ],
    formNumber: '03',
    formSubtitle: 'Giving Form',
    formTitle: 'Tell us how you would like to support VAN',
    formLead: 'Enter your contact details and preferred giving route here. Submitting opens an email draft containing your responses.',
    formLabels: {
      type: 'Giving route',
      name: 'Name',
      phone: 'Phone',
      email: 'Email',
      amount: 'Amount',
      amountCustom: 'Enter an amount',
      message: 'Anything you would like to add (optional)',
      consent: 'I agree to VAN collecting my name, phone number and email so that we can respond about donating. We use them for nothing else.',
      required: 'Required',
    },
    formAmounts: ['Undecided / discuss first', 'KRW 10,000 / month', 'KRW 30,000 / month', 'KRW 50,000 / month', 'KRW 100,000 / month', 'Other'],
    formSubmit: 'Open email with my responses',
    formCopy: 'Copy the details',
    formCopied: 'Copied',
    formHint: 'The button opens your mail app with the details filled in. If you do not use a mail app, copy the details and send them by text message instead.',
    formSubject: '[VAN Giving Enquiry]',
    formIncomplete: 'Please complete the required fields and the consent box.',
    formPlaceholders: {
      name: 'Your name',
      phone: '010-0000-0000',
      email: 'name@example.com',
      message: 'Tell us about the schedule or anything you would like to ask.',
    },
    formTypes: ['Monthly individual giving', 'Book funding', 'Corporate or institutional', 'Other enquiry'],
    formStatus: 'An email draft containing your responses has opened. Your enquiry is complete only after you send that email.',
    formPrivacy: 'This page does not store your responses on a server or in a database. If your email app does not open, email the official address below.',
    paymentTitle: 'How recurring giving works',
    paymentLead: 'Recurring card payments are not available yet. After sending the form, set VAN’s donation account as the recipient of a monthly standing order in your banking app.',
    paymentSteps: ['Complete the giving form', 'Send the generated email', 'Set up a monthly standing order in your banking app'],
    paymentAccountLink: 'See the donation account',
    contactPersonLabel: 'Donation contact',
    phoneLabel: 'Phone',
    emailLabel: 'Email',
    accountNumber: '04',
